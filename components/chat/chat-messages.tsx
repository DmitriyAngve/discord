...
export const ChatMessages = ({
  ...
  useChatScroll({
    ...
    shouldLoadMore: !isFetchingNextPage && !!hasNextPage, // "!isFetchingNextPage" -указывает, выполняется ли в данный момент запрос на загрузку. "!!hasNextPage" - указывает, есть ли еще страницы с данными для загрузки.
