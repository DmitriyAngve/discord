          ...
          <ActionTooltip label="Delete">
            <Trash
              onClick={
                ...
                // "apiUrl: `${socketUrl}/${id}`" - строка, представляющая URL-адрес, по которому будет отправлен запрос на удаление сообщения
                // "query" - объект, содержащий параметры запросы для удаления сообщения
              }
              className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
            />
          </ActionTooltip>
